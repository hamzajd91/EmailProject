...
const EditContactInfo = (props: Props) => {
  let history = useNavigate();

  const location = useLocation<Location>();

  const { data }: any = location.state as any;

  const { id, contactFullName,
    title,
    companyName,
    website,
    primaryEmail,
    ...
    companyRevenueRange,
    companyStaffCount,
    companyStaffCountRange }: any = data as any;
  ...
  return (
    <Formik
      initialValues={{
        ...
        personal_email_2: personalEmail2,
        ...
        company_state_abbr: companyStateAbbr,
        company_annual_revenue: companyAnnualRevenue,
        company_industry: companyIndustry,
        company_linkedin_profileUrl: companyLinkedinProfileUrl,
        company_revenue_range: companyRevenueRange,
        company_staff_count: companyStaffCount,
        company_staff_countRange: companyStaffCountRange,
      }}
      ...
      onSubmit={(values, { resetForm }) => {
        props.updateContactInfo({ data: values, id: id, history });
        resetForm();
      }}
    >
      {({
