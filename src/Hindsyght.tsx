...
import { SplaceLoader } from "./components/Loader";
...
function App({ location, user }: any) {
  ...
  useEffect(() => {
    console.log("BUILD 0.0.25", process.env.NODE_ENV, window.location.href);
    ...
    // if (location.pathname === '/for-service-firms' || location.pathname === '/about-us') {
    //   setShowSubNav(true);
    // } else {
    //   setShowSubNav(false);
    // }
    ...
    <div>
      {isLoading ? (
        ...
        <>
          ...
          {/* <Navigation redirectUrl={redirectUrl} showSubNav={showSubNav} /> */}
